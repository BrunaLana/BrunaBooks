...
<body>
    ...
    ?>
        <div class="row mt-1 ps-3 pe-3">
            <div class="col-sm-1 p-0 text-center d-flex align-items-center"><img src="<?php echo 'data:image/jpeg;base64,' . $item['productImg']; ?>" width="50" height="60" alt="..."></div>
            <div class="col-sm-9 p-0 d-flex align-items-center"><?php echo $item['productName']; ?></div>
            <div class="col-sm-1 p-0 text-end d-flex align-items-center"><?php echo $item['productPrice']; ?></div>
            <div class="col-sm-1 p-0 text-center d-flex align-items-center"><?php echo $itemsQtd[$item['productId']]; ?></div>
        </div>
    <?php endforeach; ?>
    <div class="row mt-1 d-flex justify-content-end pe-5 align-items-center">
        <span class="text-end me-5">Total: <?php echo CalculaTotal(); ?></span>
    </div>
</body>
<hr />
