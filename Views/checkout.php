...
<body>
    ...
    <form method="" action="" class="registroTotal">
        <div class="registro">
            <div class="registroDescricao">
                <div class="registroEntrar">
                    <h2 class="registroTitulo">Morada para entrega</h2>

                    <p class="registroTexto">Morada</p>
                    <input type="text" class="registroCampos" name="morada" required>

                    <p class="registroTexto">Número</p>
                    <input type="text" class="registroCampos" name="numero" required>

                    <p class="registroTexto">Complemento</p>
                    <input type="text" class="registroCampos" name="complemento" required>

                    <p class="registroTexto">Freguesia</p>
                    <input type="text" class="registroCampos" name="freguesia" required>

                    <p class="registroTexto">Conselho</p>
                    <input type="text"  class="registroCampos" name="conselho" required><br>

                    <p class="registroTexto">Distrito</p>
                    <input type="text"  class="registroCampos" name="distrito" required><br>

                    <p class="registroTexto">Cód.Postal</p>
                    <input type="text"  class="registroCampos" name="codigoPostal" required><br>

                    <p class="registroTexto">País</p>
                    <input type="text"  class="registroCampos" name="pais" required><br>

                    <button type="submit" class="registroBotao">Comprar</button>
